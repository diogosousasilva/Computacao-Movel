...
class AIAssistantGemini(override val properties: Properties) : AIAssistant {
    ...
    override fun buildRequest(prompt: String): Request {
        ...
        // Build generation config with temperature and max tokens from properties
        val generationConfig = JSONObject()
            .put("temperature", temperature)
            .put("maxOutputTokens", maxTokens)

        // Build the complete request body with model selection, content, and generation config
